# Sources: Work Requirements Volume

Verbatim excerpts of the governing text. Items in both approaches cite these by ID. Nothing here is interpretation. Retrieved 2026-09-02; ecfr.gov and medicaid.gov blocked automated retrieval, so CFR text was taken from the Legal Information Institute mirror and the interim final rule from the Federal Register via govinfo. Re-verify against the official sources before approval.

Draft status applies to every excerpt: a reviewer must confirm each quote against the cited source before the item that uses it can move past Draft.
...
Editorial amendment note at the same URL:
...
The former paragraph (3), still visible in the not-yet-updated regulation (S32), exempted the homeless, veterans, and former foster youth 24 and under, and set the age bound at "over 54". None of those appear in the new list.
...
Where the regulation and the amended statute conflict, this volume follows the statute and records the conflict as an open question.
